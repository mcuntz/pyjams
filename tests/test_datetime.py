...
class TestDatetime(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # self.year0   = [0, -1, -10, -100, -1000, 1]
        # self.month0  = [4] * len(self.year0)
        # self.day0    = [24] * len(self.year0)
        # self.hour0   = [16] * len(self.year0)
        # self.minute0 = [15] * len(self.year0)
        # self.second0 = [10] * len(self.year0)
        # self.idates0 = ['0000-04-24 16:15:10', '-0001-04-24 16:15:10',
        #                 '-0010-04-24 16:15:10', '-0100-04-24 16:15:10',
        #                 '-1000-04-24 16:15:10', '0001-04-24 16:15:10']
